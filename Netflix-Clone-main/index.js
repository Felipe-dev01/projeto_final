...
const apiPaths = {
    ...
    buscarTrending:`${apiEndpoint}/trending/all/day?api_key=${apikey}&language=en-US`,
}


// Inicializa o app
function inicializar() {
    buscarFilmesTrending();
    buscarEConstruirTodasSecoes();
}

function buscarFilmesTrending(){
...
function construirSecaoBanner(filme){
    ...
    div.innerHTML = `
            ...
            <p class="banner__info">Trending in movies | Released - ${filme.release_date} </p>
